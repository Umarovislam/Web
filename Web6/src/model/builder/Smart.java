 ...
 * Class Smart
 */
public class Smart implements Builder, Serializable {

    /**
     * The method returns object of class tariffBonus with species SMART
    ...
    public TariffBonus getTariffBonus(int costTariff, int costMinuteInNet, int costSms, int costMegabyte, int packageInternet, int packageMinute ) {
        TariffBonus tariffBonus = new TariffBonus(costTariff,costMinuteInNet,costSms,costMegabyte, Species.SMART,packageInternet,packageMinute);
        return tariffBonus;
    }
}